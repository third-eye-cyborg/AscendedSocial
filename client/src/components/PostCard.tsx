        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300" data-testid={`text-time-${post.id}`}>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-1">
              <Button
                variant="ghost"
                size="sm"
                className={`p-1 transition-colors duration-200 ${userEngagements.includes('upvote') ? 'text-green-400' : 'text-gray-300 hover:text-green-400'}`}
              ...
              <Button
                variant="ghost"
                size="sm"
                className={`p-1 transition-colors duration-200 ${userEngagements.includes('downvote') ? 'text-red-400' : 'text-gray-300 hover:text-red-400'}`}
            ...
            <Button
              variant="ghost"
              size="sm"
              className={`flex items-center space-x-1 transition-colors duration-200 ${userEngagements.includes('like') ? 'text-red-500' : 'text-gray-300 hover:text-red-500'}`}
            ...
            <Button
              variant="ghost"
              size="sm"
              className={`flex items-center space-x-1 transition-colors duration-200 ${userEngagements.includes('energy') ? 'text-accent-light' : 'text-gray-300 hover:text-accent-light'}`}
            ...
            <Button
              variant="ghost"
              size="sm"
              className={`flex items-center space-x-1 transition-colors duration-200 ${showComments ? 'text-primary' : 'text-gray-300 hover:text-primary'}`}

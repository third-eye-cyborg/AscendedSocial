  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cosmic via-cosmic-dark to-cosmic relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-16">
        {/* Back Button */}
        <div className="mb-8">
          <Button asChild variant="outline" className="border-primary/30 bg-background/80 text-foreground hover:bg-primary/10 hover:text-primary dark:bg-background/50 dark:text-foreground dark:hover:bg-primary/20 dark:hover:text-primary backdrop-blur-sm">
              ...
              <div>
                ...
                <Button asChild className="bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90">
                  <a 
                    ...
                    className="justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-primary/90 h-10 px-4 py-2 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 inline-flex items-center gap-2 text-[#ffffff]"
        ...
        <Card className="border border-primary/30 bg-cosmic/20 backdrop-blur-xl">
          ...
          <CardContent className="text-center">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild className="bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90">
                <a href="/api/login" data-testid="button-join-platform" className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-primary/90 h-10 px-4 py-2 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-white !text-white">
                  Join Our Platform
                </a>
              </Button>
            </div>

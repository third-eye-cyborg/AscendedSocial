          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-white/90 font-medium tracking-wide hidden sm:block">TRANSCEND • CONNECT • EVOLVE</p>
              </div>
            </div>
      ...
      <main className="relative pt-24 sm:pt-32 pb-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-white/90 mb-6 sm:mb-8 leading-relaxed max-w-4xl mx-auto px-4">
            ...
            <Card className="bg-gradient-to-br from-cosmic/90 to-cosmic/70 border border-chakra-heart/40 glass-effect shadow-xl rounded-3xl overflow-hidden hover-lift">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-white/80 mb-4">Perfect for those beginning their spiritual journey</p>
                  <div className="mb-6">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    ...
                    <span className="text-white/90">Basic community access</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-chakra-heart mr-3"></i>
                    <span className="text-white/90">Share posts & connect</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-chakra-heart mr-3"></i>
                    <span className="text-white/90">Basic energy tracking</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-chakra-heart mr-3"></i>
                    <span className="text-white/90">Weekly oracle reading</span>
                  </li>
                </ul>
            ...
            <Card className="bg-gradient-to-br from-cosmic/90 to-cosmic/70 border-2 border-primary/60 glass-effect shadow-2xl rounded-3xl hover-lift relative">
              ...
              <CardContent className="p-8 pt-12">
                <div className="text-center mb-6">
                  ...
                  <p className="text-white/80 mb-4">For dedicated practitioners seeking deeper insights</p>
                  <div className="mb-6">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    ...
                    <span className="text-white/90">Everything in Seeker</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span className="text-white/90">Personal AI sigil generation</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span className="text-white/90">Daily oracle readings</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span className="text-white/90">Chakra intelligence system</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span className="text-white/90">Advanced aura tracking</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span className="text-white/90">Sacred circles access</span>
                  </li>
                </ul>
            ...
            <Card className="bg-gradient-to-br from-cosmic/90 to-cosmic/70 border border-chakra-crown/40 glass-effect shadow-xl rounded-3xl overflow-hidden hover-lift">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-white/80 mb-4">For spiritual leaders and advanced practitioners</p>
                  <div className="mb-6">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    ...
                    <span className="text-white/90">Everything in Mystic</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-chakra-crown mr-3"></i>
                    <span className="text-white/90">AI tarot readings</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-chakra-crown mr-3"></i>
                    <span className="text-white/90">Create sacred circles</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-chakra-crown mr-3"></i>
                    <span className="text-white/90">Advanced energy analytics</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-chakra-crown mr-3"></i>
                    <span className="text-white/90">Priority community support</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-chakra-crown mr-3"></i>
                    <span className="text-white/90">Unlimited visions & sparks</span>
                  </li>
                </ul>

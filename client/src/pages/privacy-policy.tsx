          ...
          <div className="bg-gradient-to-br from-cosmic/95 to-cosmic/85 border border-primary/40 glass-effect shadow-xl rounded-3xl overflow-hidden p-8">
            ...
            <div className="text-center">
              <p className="text-white/90 text-lg leading-relaxed">
                Our complete privacy policy is embedded below. We believe in transparency and your right to understand exactly how your personal information is handled on our spiritual platform.
              </p>
            </div>
